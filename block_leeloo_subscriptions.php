 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_leeloo_subscriptions extends block_base {
    /**
     * Block initialization.
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_leeloo_subscriptions');
    }
    ...
    /**
     * Return contents of leeloo_subscriptions block
     *
    ...
    public function get_content() {
        ...
        $this->page->requires->js(new moodle_url('/blocks/leeloo_subscriptions/js/custom.js'));
        ...
        $vendorkey = get_config('block_leeloo_subscriptions', 'vendorkey');
        ...
        if (!$output = $curl->post($url, $postdata, $options)) {
            $this->content->text = get_string('nolicense', 'block_leeloo_subscriptions');
            return $this->content;
        }
        ...
        foreach ($prodcutslist as $productsin) {
            ...
            $leeloodiv = "<div class='leeloo_subsdiv' id='leeloo_div_$productid'>
                $buybuttonhtml
            </div>";
            ...
            $this->content->text .= '<div class="leeloo_subsc_image"><img style="width: 100%;" src="' .
